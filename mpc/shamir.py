...
def main():
    ...
    # We have 3 users
    # sum = 30
    shares1 = make_random_shares(12, minimum=3, shares=3)
    shares2 = make_random_shares(8, minimum=3, shares=3)
    shares3 = make_random_shares(10, minimum=3, shares=3)
    shares4 = make_random_shares(10, minimum=3, shares=3)
